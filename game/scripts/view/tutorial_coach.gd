...
const STEPS := [
	...
	{"id": &"close", "title": "Get it signed",
		"body": "They said yes - but it isn't money until they sign. Double-click the empty tablet to close - on a phone, tap it twice. Anything unsigned when the shift ends is lost.",
